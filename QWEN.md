...
Все изменения логики, архитектуры и игровых механик **обязательно** записываются в `CHANGELOG.md` в корне проекта.

**Когда записывать:**
Запись в журнал производится **после того, как изменения закоммичены и запушены** в репозиторий.

**Команды для обновления:**
- «Обнови CHANGELOG.md по последнему коммиту»
- «Запиши последние изменения в CHANGELOG.md»
...
4. Генерирую запись в `CHANGELOG.md` в формате ниже
